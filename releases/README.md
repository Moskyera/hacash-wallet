...
**File:** `hacash-wallet-mobile-v0.1.0-arm64.apk`  
...
```
https://github.com/Moskyera/hacash-wallet/raw/main/releases/hacash-wallet-mobile-v0.1.0-arm64.apk
```
...
```powershell
Get-FileHash releases\hacash-wallet-mobile-v0.1.0-arm64.apk -Algorithm SHA256
```
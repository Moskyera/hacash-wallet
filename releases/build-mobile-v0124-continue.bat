...
set "LOG=%MOBILE%\rebuild-v0124-continue.log"
set "VER=0.1.24"

echo === v%VER% continue started %DATE% %TIME% === > "%LOG%"
...
echo === v%VER% continue OK %DATE% %TIME% === >> "%LOG%"
exit /b 0

:fail
echo === v%VER% continue FAILED %DATE% %TIME% === >> "%LOG%"
exit /b 1
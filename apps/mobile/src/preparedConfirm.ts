 ...
 * being approved. The Android biometric prompt renders the text we hand it, but
 * that text is the only place it appears. Without this step the trusted display is built by the

...
echo === Elevated Android build started %DATE% %TIME% === > tauri-android-build2.log
...
echo === Elevated Android build finished exit=%ERRORLEVEL% %DATE% %TIME% === >> tauri-android-build2.log
exit /b %ERRORLEVEL%
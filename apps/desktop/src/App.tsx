      ...
      <main className="content">
        ...
        <DesktopRouter
          ...
          actions={{
            ...
            onCreate: (p) => void wallet.handleCreate(p),
            onImport: (s, p) => void wallet.handleImport(s, p),
            onWatchOnly: (a) => void wallet.handleWatchOnlyImport(a),
            onUnlock: (p) => void wallet.handleUnlock(p),
            onLock: handleLock,
            onOpenQrPay: hacSend.openQrPay,
            onWebAuthnSession: () => void wallet.handleWebAuthnSession(),
            onEnableFastPay: (d) => void wallet.handleEnableFastPay(d),
            onApplyHub: wallet.handleApplyHub,
            onSaveL2Settings: (n, h, a) => void wallet.handleSaveL2Settings(n, h, a),
            onHubHealth: () => void wallet.handleHubHealth(),
            onPreviewChannel: (...args) => void wallet.handlePreviewChannel(...args),
            onOpenChannel: (...args) => void wallet.handleOpenChannel(...args),
            onCloseChannel: (cb) => void wallet.handleCloseChannel(cb),
            onRegisterWebAuthn: () => void wallet.handleRegisterWebAuthn(),
            onSetProfile: (p) => void wallet.handleSetProfile(p),
            onSetHardwareMode: (m) => void wallet.handleSetHardwareMode(m),
            onSaveSettings: (n) => void wallet.handleSaveSettings(n),
            onChangePassphrase: (o, n, c) => wallet.handleChangePassphrase(o, n, c),
            onExportBackup: wallet.handleExportBackup,
            onValidateHip23: handleValidateHip23,
            onSavePrivacy: (d) => void wallet.handleSavePrivacy(d),
            ...
            onPaymentQr: (p) => void hacSend.handlePaymentQr(p),
